...
namespace Dymatic {
	...
	{
		m_DymaticLogo = Texture2D::Create("assets/icons/DymaticLogoTransparentLarge.png");
	...
	void CrashManagerLayer::OnImGuiRender()
	{
		...
		ImGui::PopFont();
		ImGui::TextWrapped("Unfortunately a crash occurred, and the Dymatic process was terminated. Providing log and profiling information can help to improve or fix any issues that Dymatic Engine has. All data is sent anonymously.");
