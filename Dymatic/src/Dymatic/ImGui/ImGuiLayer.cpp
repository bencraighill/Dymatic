...
namespace Dymatic {
	...
	void ImGuiLayer::SetColorScheme(EngineColorScheme colorScheme)
	{

		m_ColorScheme = colorScheme;

		if (colorScheme == EngineColorScheme::Dark)
		{
		...
		else if (colorScheme == EngineColorScheme::Light)
		{
			auto& colors = ImGui::GetStyle().Colors;
			...
			colors[ImGuiCol_HeaderHovered] = ImVec4{ 0.32f, 0.32f, 0.32f, 1.0f };
			...
			// Tabs
			colors[ImGuiCol_Tab] = ImVec4{ 0.22f, 0.22f, 0.22f, 1.0f };
			colors[ImGuiCol_TabHovered] = ImVec4{ 0.26f, 0.26f, 0.26f, 1.0f };
			colors[ImGuiCol_TabActive] = ImVec4{ 0.24f, 0.24f, 0.24f, 1.0f };
			colors[ImGuiCol_TabUnfocused] = ImVec4{ 0.22f, 0.22f, 0.22f, 1.0f };
			colors[ImGuiCol_TabUnfocusedActive] = ImVec4{ 0.23f, 0.23f, 0.23f, 1.0f };

			// Title
			colors[ImGuiCol_TitleBg] = ImVec4{ 0.26f, 0.26f, 0.26f, 1.0f };
			colors[ImGuiCol_TitleBgActive] = ImVec4{ 0.26f, 0.26f, 0.26f, 1.0f };
			colors[ImGuiCol_TitleBgCollapsed] = ImVec4{ 0.26f, 0.26f, 0.26f, 1.0f };
		}
	}
