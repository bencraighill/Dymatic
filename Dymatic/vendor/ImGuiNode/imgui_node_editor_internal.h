...
struct EditorContext
{
    ...
    void NavigateTo(const ImRect& bounds, bool zoomIn = false, float duration = -1, bool exact = false)
    {
        // IMGUI CUSTOM
        auto zoomMode = zoomIn ? (exact ? NavigateAction::ZoomMode::Exact : NavigateAction::ZoomMode::WithMargin) : NavigateAction::ZoomMode::None;
