...
IMGUI_NODE_EDITOR_API void GetNodeBounds(NodeId nodeId, ImVec2& min, ImVec2& max);
IMGUI_NODE_EDITOR_API void SetNodeBounds(NodeId nodeId, const ImVec2& min, const ImVec2& max);
...
// IMGUI CUSTOM
IMGUI_NODE_EDITOR_API void NavigateTo(const ImVec2& position, float duration = -1);
IMGUI_NODE_EDITOR_API void NavigateTo(const ImVec2& min, const ImVec2& max, float duration = -1);
IMGUI_NODE_EDITOR_API void GetViewRect(ImVec2& min, ImVec2& max);
// ------------
...
IMGUI_NODE_EDITOR_API void GetSelectionBounds(ImVec2& min, ImVec2& max);
