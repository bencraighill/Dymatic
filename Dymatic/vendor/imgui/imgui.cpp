...
//IMGUI CUSTOM: (for imgui node editor additions)
// Stack Layout
...
ImGuiWindow::~ImGuiWindow()
{
    ...
    //IMGUI CUSTOM: (Addition made as part of imgui node editor)
...
bool ImGui::Begin(const char* name, bool* p_open, ImGuiWindowFlags flags)
{
    ...
    if (first_begin_of_the_frame)
    {
        ...
        */
        ...
        //IMGUI CUSTOM: (addition as part of imgui node editor)
...
//IMGUI CUSTOM: Whole of layout section is included in IMGUI CUSTOM, as part of imgui node editor additions for dymatic.
