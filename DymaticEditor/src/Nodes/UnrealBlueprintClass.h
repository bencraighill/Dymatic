...
namespace Dymatic {
	...
	public:
		...
		void bpf__ExecuteUbergraph_UnrealBlueprintClass__pf_255(int32_t bpp__EntryPoint__pf);
		void bpf__ExecuteUbergraph_UnrealBlueprintClass__pf_256(int32_t bpp__EntryPoint__pf);
		DYFUNCTION(BlueprintCallable)
