// Default Dymatic Node Library V1.2.5
...
public:
	...
	*/
	...
	DYFUNCTION(DisplayName = "Make Color", Category = "Math|Color", Keywords = "split", Pure, NativeMakeFunc)
	static Color Make_Color(float r, float g, float b, float a);

	DYFUNCTION(DisplayName = "Make Byte", Category = "Math|Byte", Keywords = "split", Pure, NativeMakeFunc)
