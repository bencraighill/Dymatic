...
void ax::Drawing::DrawIcon(ImDrawList* drawList, const ImVec2& a, const ImVec2& b, IconType type, bool filled, ImU32 color, ImU32 innerColor)
{
    ...
    else
    {
		...
		else if (type == IconType::Braces)
		{
            ...
            drawList->AddBezierCubic(ImVec2(rect_x, rect_center_y), ImVec2(rect_center_x - gap, rect_center_y), ImVec2(rect_x, rect_y), ImVec2(rect_center_x - gap, rect_y), color, thickness);
            drawList->AddBezierCubic(ImVec2(rect_x, rect_center_y), ImVec2(rect_center_x - gap, rect_center_y), ImVec2(rect_x, rect_y + rect_h), ImVec2(rect_center_x - gap, rect_y + rect_h), color, thickness);
            drawList->AddBezierCubic(ImVec2(rect_x + rect_w, rect_center_y), ImVec2(rect_center_x + gap, rect_center_y), ImVec2(rect_x + rect_w, rect_y), ImVec2(rect_center_x + gap, rect_y), color, thickness);
            drawList->AddBezierCubic(ImVec2(rect_x + rect_w, rect_center_y), ImVec2(rect_center_x + gap, rect_center_y), ImVec2(rect_x + rect_w, rect_y + rect_h), ImVec2(rect_center_x + gap, rect_y + rect_h), color, thickness);
		}
        else
        {
