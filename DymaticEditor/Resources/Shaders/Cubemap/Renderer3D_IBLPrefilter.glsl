...
void main()
{
    // Reuse u_ModelInverse to represent u_Roughness
    float u_Roughness = u_ModelInverse[0][0];
    ...
    for(uint i = 0u; i < SAMPLE_COUNT; ++i)
    {
        ...
        if(NdotL > 0.0)
        {
            ...
            prefilteredColor += textureLod(u_EnvironmentMapSampler, L, mipLevel).rgb * NdotL;
            totalWeight      += NdotL;
        }
    }
