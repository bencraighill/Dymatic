...
void main() 
{
   ...
   o_Color = u_BokehList[a_Index].color;
   gl_Position = vec4(a_Position.xy * (u_PixelSize * u_BokehList[a_Index].size) + (u_BokehList[a_Index].position * 2.0 - vec2(1.0)), 0.0, 1.0);
}
