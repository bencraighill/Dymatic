...
layout (set = 0, binding = 0) uniform sampler2D u_TexNoise;
...
void main()
{
    ...
    vec3 fragPos = PositionFromDepth(texture(g_Depth, v_TexCoord).r).xyz;
    ...
    for(int i = 0; i < kernelSize; ++i)
    {
        ...
        // get sample depth
        float sampleDepth = PositionFromDepth(texture(g_Depth, offset.xy).r).z; // get depth value of kernel sample
